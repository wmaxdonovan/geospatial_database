...
def query_options(database):
    ...
    try:
        if select == 1:
            ...
            county_id = int(input('search county id: \t'))
            database.get_land_by_county(county_id, county_name)
        elif select == 2:
            ...
            county_id = int(input('county id for search: \t'))
            county_name = input('county name for search: \t')
            database.get_owners_in_county(county_id, county_name)
        elif select == 9:
